            ...
            ((function (A) {
                var e = (function (A) {
                    ...
                    function S(A, t) {
                        ...
                        return n
                            ? n.done
                                ? ((t[A.resultName] = n.value), (t.next = A.nextLoc), "return" !== t.method && ((t.method = "next"), (t.arg = e)), (t.delegate = null), s)
                                : n
                    ...
                    function J(A) {
                        if (A) {
                            ...
                            if (!isNaN(A.length)) {
                                var i = -1,
                                    B = function t() {
                                        for (; ++i < A.length;) if (g.call(A, i)) return (t.value = A[i]), (t.done = !1), t;
                    ...
                    return (
                        (l.prototype = d.constructor = u),
                        (u.constructor = l),
                        (u[E] = l.displayName = "GeneratorFunction"),
                    ...
                    },
                    {
                        ...
                        value: function (A) {
                            if (0 !== A.length) {
                                ...
                                var i = new CustomEvent("fileUploadWithPreview:imagesAdded", { detail: { uploadId: this.uploadId, cachedFileArray: this.cachedFileArray, addedFilesCount: e } });
